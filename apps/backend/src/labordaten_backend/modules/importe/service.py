...
- Bei jedem neuen Parameter-Vorschlag ist eine nicht-leere kurze allgemeine "beschreibungKurz" Pflicht. Recherchiere beziehungsweise nutze allgemeines Laborwissen, um in 1-2 Sätzen zu beschreiben, was der Parameter fachlich misst oder typischerweise abbildet.
...
- Lege keinen Parameter-Vorschlag ohne belastbare "beschreibungKurz" an. Wenn auch nach kurzer Recherche beziehungsweise anhand allgemeiner Laborfachkenntnis keine Bedeutung ableitbar ist, lasse den Parameter-Vorschlag weg, markiere den Messwert mit "pruefbedarfFlag": true und erkläre die Unsicherheit in "kiHinweis".
