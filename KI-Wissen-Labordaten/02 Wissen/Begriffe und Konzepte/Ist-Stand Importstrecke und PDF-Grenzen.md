...
- Die allgemeine Löschprüfung für Importvorgänge kann bei noch nicht übernommenen Importen über `Importversuch löschen` ein exklusiv verknüpftes Importdokument optional mitlöschen. Wird dasselbe Dokument bereits durch andere Importe oder Befunde referenziert, bleibt diese Option gesperrt.
